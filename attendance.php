  ...
  <div class="card">
      ...
      <div class="row">
		...
		<!--	<input type="file" name="fileToUpload" id="fileToUpload"> -->
			<input type="submit" value="Download Attendance_file" name="Download">
			</form>
		  <form action="upload.php" method="post" enctype="multipart/form-data">
		<!--	<input type="file" name="fileToUpload" id="fileToUpload"> -->
			<input type="submit" value="Upload Attendance_file" name="Upload">
			</form>
			<form action="archive.php" method="post" enctype="multipart/form-data">
		<!--	<input type="file" name="fileToUpload" id="fileToUpload"> -->
			<input type="submit" value="Move To Glacier" name="Move to Glacier">
			</form>
		   <!-- <button type="button" id="upload_button" class="btn btn-info btn-sm" onclick=func()>Upload</button>  -->
        </div>
      </div>
    </div>
  	<div class="card-body">
              ...
              <table class="table table-striped table-bordered">
                ...
                ?>
                  <tr>
					...
					<td>
					<input type="text"  name="reason for absence <?php echo $student["student_id"]; ?>"  />
                  </tr>
                <?php
                }
                ?>
